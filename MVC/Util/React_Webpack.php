 ...
 * React Webpack
 *
 * Using hot module swapping with react requires that the script is pulled
 * from an internal http://localhost:3000. When loading on a real environment
 * we do not use hot module swapping.
...
class React_Webpack {
	 ...
	 * node_running_check
	 *
	 * Set to false to prevent the extra check
	 * when deciding to load node or not
	 *
	 * @var bool
	 */
	private $node_running_check = true;
	...
	/**
	 * If you want to skip the check for node server
	 * before pointing to it send this false.
	 ...
	 * @return void
	 */
	public function set_node_running_check( $check ){
		$this->node_running_check = $check;
	}
