 ...
 *
 * You may turn this on by using add_theme_support( 'mvc_route' );
...
class Route {
	...
	protected function add_post_hooks(){
		...
		add_filter( 'body_class', array( $this, 'adjust_body_class' ), 99 );
	...
	public function adjust_body_class( $classes ){
		unset( $classes[ array_search(  'mvc_placeholder_post', $classes ) ] );
		$post = get_post();
